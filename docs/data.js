...
window.UNIBOX = {
  ...
  meta: {
    ...
    afterTerm: [
      { label: "Break — weeks 15–17", detail: "2026-12-14 → 2027-01-03. Three weeks, absorbing the holidays and the resort's peak season. Nothing. Actually nothing." },
      { label: "Term B opens", detail: "2027-01-04 → 2027-04-11 · PSY-201, PSY-202" }
    ],
    owedLater: [
      {
  ...
  courses: [
    {
      ...
      readDay: "Wed",
      weeks: [
        { n: 1,  start: "2026-09-07", end: "2026-09-13",
        ...
        { n: 4,  start: "2026-09-28", end: "2026-10-04",
        ...
        { n: 8,  start: "2026-10-26", end: "2026-11-01",
        ...
        { n: 12, start: "2026-11-23", end: "2026-11-29",
          ...
          output: "600w", fromCatalog: true },
        { n: 13, start: "2026-11-30", end: "2026-12-06",
          ...
          output: "600w", fromCatalog: true },
        { n: 14, start: "2026-12-07", end: "2026-12-13",
...

    {
      ...
      weeks: [
        { n: 1,  start: "2026-09-07", end: "2026-09-13",
          ...
          sources: [{ text: "Spiegelhalter 1–2", tag: "H" }],
          output: "600w" },
        { n: 2,  start: "2026-09-14", end: "2026-09-20",
        ...
        { n: 9,  start: "2026-11-02", end: "2026-11-08",
          ...
          sources: [{ text: "Spiegelhalter", tag: "H" }],
          output: "600w", fromCatalog: true },
        { n: 10, start: "2026-11-09", end: "2026-11-15",
