...

    {
      ...
      weeks: [
        ...
        { n: 9,  start: "2026-10-19", end: "2026-10-25",
          ...
          sources: [{ text: "Spiegelhalter", tag: "R" }],
          output: "600w", fromCatalog: true },
        { n: 10, start: "2026-10-26", end: "2026-11-01",
      ...
      ledger: [
        { id: "S1", source: "Spiegelhalter, The Art of Statistics (2019) ch. 1–2", wk: "1", tag: "R", verified: "—", status: "verify before buying — only purchase required" },
