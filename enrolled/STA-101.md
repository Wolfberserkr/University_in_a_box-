...
|---|---|---|---|---|---|
| 1 | 08-24 → 08-30 | What a number claims: population, sample, estimand | Spiegelhalter 1–2 `[R]` | 600w | ☐ |
...
|---|---|---|---|---|---|
| S1 | Spiegelhalter, *The Art of Statistics* (2019) ch. 1–2 | 1 | `[R]` | — | **verify before buying** — only purchase required |
...
Five of six named sources are `[V]` and four are free. **This is the cheapest course in the catalog to start.**
