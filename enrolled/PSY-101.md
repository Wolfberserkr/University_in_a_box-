...
| 3 | 09-07 → 09-13 | Effect size, interval, precision — **compute three by hand** | Cumming 1–3 `[R]` | 600w + computations | ☐ |
| 4 | 09-14 → 09-20 | Power; why underpowered significant results are usually wrong | Cumming, cont. | 600w | ☐ |
...
| 13 | Cumming, *Understanding The New Statistics* (2012) ch. 1–3 | 3–4 | `[R]` | — | **verify before buying** |
...
Ten of twelve `[V]`. Retag `[H]` as each lands in NotebookLM. **Nothing gets read from an untagged row.**
