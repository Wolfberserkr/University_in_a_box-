...
|---|---|---|---|---|---|
| 1 | 08-24 → 08-30 | The replication crisis: scale and shape | OSC 2015 `[V]` + Ritchie 1–2 `[V]` | **Priors Sheet**, 600w | ☐ |
...
| 5 | 09-21 → 09-27 | Publication bias, file drawer, p-curve | Ritchie 3–4 `[V]` | 600w | ☐ |
...
| 12 | Ritchie, S. *Science Fictions* (2020) ch. 1–2 | 1 | `[V]` | Metropolitan Books, ISBN 978-1-250-22269-5 · Wikipedia · Goodreads | **exists — safe to buy.** Two subtitles by region, same book |
...
Eleven of eleven `[V]` as of 2026-08-21. Weeks 3–4 consume STA-101's sources rather than carrying their own — see the interlock note in `REGISTRAR.md`. Retag `[H]` as each lands in NotebookLM. **Nothing gets read from an untagged row.**
