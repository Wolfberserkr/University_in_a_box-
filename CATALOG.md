...
Your year has room for **six courses**. Psychology fills five of them plus the capstone — but PSY-101 has to run alone in Term A, because everything else depends on it.

That leaves **one open slot in Term A, weeks 1–14**, and it wants a second subject.

| Term | Slot 1 | Slot 2 |
|---|---|---|
| **A** · wk 1–14 | PSY-101 | **← open** |
| **B** · wk 16–29 | PSY-201 | PSY-202 |
| **C** · wk 31–44 | PSY-301 | PSY-302 |
| **Capstone** · wk 45–52 | PSY-401 | — |

A second subject is not a distraction from psychology. It is the thing that stops one vocabulary from becoming the only vocabulary you can think in — the same argument as the Roommate agent, run at course scale instead of fortnightly.

**Good pairings with a psychology major**, if you want a recommendation rather than a blank page:

| Subject | 100-level course it would open with | Why it pairs |
|---|---|---|
| **Statistics & Inference** | STA-101 — Reading Quantitative Claims | Turns PSY-101's protective week 3 into a real skill. Highest-leverage pairing available. |
...
Or name something not on this list. The catalog is not fixed; it's a directory.
